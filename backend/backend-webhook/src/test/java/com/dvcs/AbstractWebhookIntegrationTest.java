...
/**
 * Base class for webhook module integration tests using Testcontainers.
 *
...
@SpringBootTest(
        ...
        classes = WebhookTestApplication.class
)
@AutoConfigureMockMvc
@Testcontainers
public abstract class AbstractWebhookIntegrationTest {

    @Container
    static final PostgreSQLContainer<?> POSTGRES = new PostgreSQLContainer<>("postgres:16-alpine")
            .withDatabaseName("dvcs_webhook_test")
            .withUsername("dvcs")
            .withPassword("dvcs");
    ...
    static void configureProperties(DynamicPropertyRegistry registry) {
        ...
        registry.add("storage.root",
                () -> System.getProperty("java.io.tmpdir") + "/dvcs-webhook-test-objects");
    }
}

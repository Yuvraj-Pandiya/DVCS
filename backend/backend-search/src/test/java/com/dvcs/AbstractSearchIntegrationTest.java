...
/**
 * Base class for search module integration tests using Testcontainers.
 *
...
@SpringBootTest(
        ...
        classes = SearchTestApplication.class
)
...
public abstract class AbstractSearchIntegrationTest {
    ...
    static final PostgreSQLContainer<?> POSTGRES = new PostgreSQLContainer<>("postgres:16-alpine")
            .withDatabaseName("dvcs_search_test")
            .withUsername("dvcs")
            .withPassword("dvcs");
    ...
    static void configureProperties(DynamicPropertyRegistry registry) {
        ...
        registry.add("storage.root", () -> System.getProperty("java.io.tmpdir") + "/dvcs-search-test-objects");
    }
}

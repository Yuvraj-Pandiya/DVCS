-- =============================================================================
-- V1__init.sql — Initial schema migration for the DVCS Platform
-- Creates all 18 tables with FK constraints, CHECK constraints, and indexes.
-- Tables are ordered by dependency (referenced tables before referencing tables).
-- =============================================================================

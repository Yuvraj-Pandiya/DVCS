...
/**
 * Base class for notification module integration tests using Testcontainers.
 *
...
@SpringBootTest(
        ...
        classes = NotificationTestApplication.class
)
...
public abstract class AbstractNotificationIntegrationTest {
    ...
    static final PostgreSQLContainer<?> POSTGRES = new PostgreSQLContainer<>("postgres:16-alpine")
            .withDatabaseName("dvcs_notification_test")
            .withUsername("dvcs")
            .withPassword("dvcs");
    ...
    static void configureProperties(DynamicPropertyRegistry registry) {
        ...
        registry.add("storage.root",
                () -> System.getProperty("java.io.tmpdir") + "/dvcs-notification-test-objects");
    }
}

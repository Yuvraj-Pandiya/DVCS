...
/**
 * Base class for issue module integration tests using Testcontainers.
 *
...
@SpringBootTest(
        ...
        classes = IssueTestApplication.class
)
...
public abstract class AbstractIssueIntegrationTest {
    ...
    static final PostgreSQLContainer<?> POSTGRES = new PostgreSQLContainer<>("postgres:16-alpine")
            .withDatabaseName("dvcs_issue_test")
            .withUsername("dvcs")
            .withPassword("dvcs");
    ...
    static void configureProperties(DynamicPropertyRegistry registry) {
        ...
        registry.add("storage.root", () -> System.getProperty("java.io.tmpdir") + "/dvcs-issue-test-objects");
    }
}

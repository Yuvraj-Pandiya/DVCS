...
/**
 * Base class for pipeline module integration tests using Testcontainers.
 *
...
@Testcontainers
public abstract class AbstractPipelineIntegrationTest {

    @Container
    static final PostgreSQLContainer<?> POSTGRES = new PostgreSQLContainer<>("postgres:16-alpine")
            .withDatabaseName("dvcs_pipeline_test")
            .withUsername("dvcs")
            .withPassword("dvcs");
    ...
    static void configureProperties(DynamicPropertyRegistry registry) {
        ...
        registry.add("storage.root",
                () -> System.getProperty("java.io.tmpdir") + "/dvcs-pipeline-test-objects");
    }
}
